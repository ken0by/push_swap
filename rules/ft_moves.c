...
/*   Updated: 2023/04/15 23:43:30 by rodro            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int ft_check_revrot(t_lst **a, t_lst **b, t_lst *aux, t_lst *aux1)
{
	...
	if ((a[0]->n > aux->n) && (aux2->n > aux->n) && b[0] && (b[0]->n > aux1->n) && (aux3->n > aux1->n))
		ft_rrotate_r(a[0], b[0]);
...
t_lst *ft_swap(t_lst **a, t_lst *b)
{
	...
	while (flag == 1)
	{
		...
		if ((flag == 1) && (aux->n > aux1->n) && aux3 && aux2 && (aux2->n < aux3->n) && ft_count(a[0]) > 1 && ft_count(b) > 1)
		{
			ft_swap_s(a[0], b);
			flag = 1;
			ft_printf("ss\n");
